...
import Segments from '@/pages/advisor/Segments';
import SegmentDetail from '@/pages/advisor/SegmentDetail';
import CriteriaList from '@/pages/advisor/CriteriaList';
import CriterionForm from '@/pages/advisor/CriterionForm';
import ModelsList from '@/pages/advisor/ModelsList';
import ModelDetail from '@/pages/advisor/ModelDetail';
...
import CreateCandidate from '@/pages/advisor/CreateCandidate';
import AdvisorCreateOffer from '@/pages/advisor/AdvisorCreateOffer';
    ...
    <BrowserRouter>
      <Routes>
        ...
        >
          ...
          />
          <Route path="/candidate/search/offers" element={<AdvisorSearchOffers />} />
        </Route>
        ...
        >
          ...
          <Route path="/provider/search/offers" element={<AdvisorSearchOffers />} />
          <Route path="/provider/search/candidates" element={<AdvisorSearchCandidates />} />
        ...
        >
          ...
          <Route path="/advisor/functional-admin" element={<ModelsList />} />
          <Route path="/advisor/functional-admin/new" element={<ModelDetail />} />
          <Route path="/advisor/functional-admin/:modelId" element={<ModelDetail />} />

          <Route path="/advisor/matching-config" element={<CriteriaList />} />
          <Route path="/advisor/matching-config/new" element={<CriterionForm />} />
          <Route path="/advisor/matching-config/:id" element={<CriterionForm />} />
          ...
          <Route path="/advisor/segments" element={<Segments />} />
          <Route path="/advisor/segments/new" element={<SegmentDetail />} />
          <Route path="/advisor/segments/:segmentId" element={<SegmentDetail />} />
          <Route path="/advisor/create-candidate" element={<CreateCandidate />} />
          <Route path="/advisor/create-offer" element={<AdvisorCreateOffer />} />
        </Route>
